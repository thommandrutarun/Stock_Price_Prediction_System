...
const About = () => {
  const aboutSchema = {
    ...
    "@type": "WebPage",
    "name": "About DeepStock - AI Stock Analytics & Predictions",
    "description": "Learn about DeepStock's advanced LSTM neural network configurations, simulated broker mechanics, and India's leading AI financial forecasting platform."
  };
  ...
  return (
    <div className="home-container" style={{ display: 'flex', flexDirection: 'column', gap: '2rem', padding: '2rem' }}>
      <SEO 
        ...
        description="Discover the technology powering DeepStock. Learn about our recurrent neural network architectures, LSTM hyperparameters, and simulated trading systems."
        keywords="about deepstock, LSTM stock prediction technology, quantitative finance AI, virtual share market india, neural network checkpoints"
        schema={aboutSchema}
      />
      ...
      <section className="ds-hero-react" style={{ textAlign: 'center', padding: '3rem 1.5rem' }}>
        <h1 className="ds-hero-title-react" style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>
          About DeepStock Analytics
        </h1>
        <p className="ds-hero-subtitle-react" style={{ maxWidth: '800px', margin: '0 auto', color: 'var(--text-secondary)' }}>
          We bridge the gap between complex artificial intelligence research and retail trading education. DeepStock provides quantitative price forecasting models alongside a high-fidelity virtual exchange, enabling risk-free training and deep temporal sequence analysis.
        </p>
