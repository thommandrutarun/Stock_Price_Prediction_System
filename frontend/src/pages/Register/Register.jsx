  ...
  return (
    <div className="auth-page-container register-page-wrap" style={{ display: 'flex', flexDirection: 'column', gap: '2rem', minHeight: '90vh' }}>
      ...
      <SEO 
        ...
        description="Join India's premier AI stock forecasting and simulation floor. Register a free account to test trading strategies and learn machine learning technical markers."
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem', width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="register-benefits-panel glass-panel" style={{ padding: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', justifyContent: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <h3 style={{ fontSize: '1.4rem', margin: 0 }}>DeepStock Membership Benefits</h3>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div>
                <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', margin: 0 }}>Simulated Brokerage Account</h4>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div>
                <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', margin: 0 }}>LSTM Forecast Inference</h4>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', margin: '4px 0 0 0' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div>
                <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', margin: 0 }}>Custom Portfolios & Real-Time Performance</h4>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', margin: '4px 0 0 0' }}>
      ...
      <div className="glass-panel" style={{ padding: '2.5rem', width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1rem' }}>
          ...
          <h3 style={{ fontSize: '1.25rem', margin: 0, color: 'var(--text-primary)' }}>Compliance Audit Logs & Account Verification Checkpoints</h3>
        </div>
      ...
      <div className="glass-panel" style={{ padding: '2.5rem', width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
        <h3 style={{ fontSize: '1.25rem', marginBottom: '1rem', color: 'var(--text-primary)' }}>Frequently Asked Registration Enquiries</h3>
        
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginTop: '1rem' }}>
          <div>
            <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '6px' }}>Is the registration free?</h4>
          ...
          <div>
            <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '6px' }}>How is my profile data handled?</h4>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
          ...
          <div>
            <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '6px' }}>Can I register multiple accounts?</h4>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
          ...
          <div>
            <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '6px' }}>What happens if registration fails?</h4>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
