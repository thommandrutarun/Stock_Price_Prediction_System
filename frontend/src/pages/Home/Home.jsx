...
const Home = () => {
  ...
  return (
    <div className="home-container">
      ...
      <section className="home-technical-guide glass-panel" style={{ marginTop: '2.5rem' }}>
        ...
        <div className="alert-box-info" style={{ background: 'rgba(59, 130, 246, 0.08)', padding: '1.25rem', borderRadius: '12px', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
          <Award size={24} style={{ color: 'var(--primary)', flexShrink: 0, marginTop: '2px' }} />
          <div>
            <h3 style={{ margin: 0, fontSize: '1rem', color: 'var(--text-primary)' }}>High-Accuracy Sequential Memory</h3>
      ...
      <section className="home-faq-section glass-panel" style={{ marginTop: '2.5rem' }}>
        ...
        <div className="faq-grid" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>1. What is the Stock Price Prediction System?</h3>
          ...
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>2. How accurate are the AI price predictions?</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
          ...
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>3. Which stock markets are supported by the platform?</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
          ...
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>4. Do I need real capital to use the virtual exchange?</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
          ...
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>5. How does the technical screener generate candlestick charts?</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
          ...
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>6. How often is the AI model updated and retrained?</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
          ...
          <div className="faq-item" style={{ paddingBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '1.1rem', marginBottom: '8px', color: 'var(--text-primary)' }}>7. Can I customize the hyperparameters of the neural networks?</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
      ...
      <section className="home-disclaimer glass-panel" style={{ marginTop: '2.5rem', borderLeft: '4px solid var(--error)' }}>
